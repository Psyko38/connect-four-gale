...
/* Configuration et affichage grille*/
function setupGride() {
  GrideGameDiv = [];
  GrideGameGrid = [];
  let space = 0;
...
/* Impression et mise à jour de la grille */
function PrintGride() {
...
/* Vérification du gagnant et fin jeu*/
